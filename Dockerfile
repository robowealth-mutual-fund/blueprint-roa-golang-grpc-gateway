...
ENV GOPRIVATE="https://domain.com/*"
ENV GONOSUMDB="domain.com/*"
ENV GITLAB_USERNAME="user_git"
ENV GITLAB_TOKEN="xxxxxxx"
...
RUN git config \
--global \
url."https://${GITLAB_USERNAME}:${GITLAB_TOKEN}@domain.com".insteadOf \
"https://domain.com"
